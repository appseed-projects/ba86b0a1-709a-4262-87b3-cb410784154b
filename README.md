...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-22 08:46`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ba86b0a1-709a-4262-87b3-cb410784154b.git
$ cd ba86b0a1-709a-4262-87b3-cb410784154b
```
